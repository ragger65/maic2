...
![Simulations #6 (left panels) and #39 (right panels): Volume of the north-polar and south-polar layered deposits ($V_\mathrm{NPLD}$, $V_\mathrm{SPLD}$; polewards of $75^\circ\mathrm{N/S}$), and ice thickness at the respective poles ($H_\mathrm{NP}$, $H_\mathrm{SP}$). \label{fig_vol_thk_paleo}](Figure_Vol_Thk_Paleo.png){ width=99% }
...
![Simulation #40: Volume of the north-polar and south-polar layered deposits ($V_\mathrm{NPLD}$, $V_\mathrm{SPLD}$; polewards of $75^\circ\mathrm{N/S}$), and ice thickness at the respective poles ($H_\mathrm{NP}$, $H_\mathrm{SP}$). \label{fig_vol_thk_future}](Figure_Vol_Thk_Future.png){ width=50% }
